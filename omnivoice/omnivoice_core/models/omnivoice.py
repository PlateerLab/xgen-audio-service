...
from omnivoice_core.utils.audio import (
    cross_fade_chunks,
    fade_and_pad_audio,
    load_audio,
    remove_silence,
...
from omnivoice_core.utils.duration import RuleDurationEstimator
from omnivoice_core.utils.lang_map import LANG_IDS, LANG_NAMES
from omnivoice_core.utils.text import add_punctuation, chunk_text_punctuation
from omnivoice_core.utils.voice_design import (
    _INSTRUCT_ALL_VALID,
    _INSTRUCT_EN_TO_ZH,
...
def _resolve_language(language: Optional[str]) -> Union[str, None]:
    from omnivoice_core.utils.lang_map import LANG_IDS, LANG_NAME_TO_ID
